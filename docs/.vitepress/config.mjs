  ...
  locales: {
    root: {
      ...
      themeConfig: {
        ...
        nav: [{ text: 'Documents', link: '/what-is-hdzero' }],
        sidebar: [
          {
            text: 'Home',
            items: [{ text: 'What is HDZero?', link: '/what-is-hdzero' }]
          },
          {
            text: 'VTX',
            items: [
    ...
    zh: {
      ...
      themeConfig: {
        ...
        nav: [{ text: '文档', link: '/zh/what-is-hdzero' }],
        sidebar: [
          {
            text: '首页',
            items: [{ text: '什么是 HDZero?', link: '/zh/what-is-hdzero' }]
          },
          {
            text: '视频发射机',
            items: [
